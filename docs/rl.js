...
var RL_SEARCH = [
  ...
  {t:'Echelle de severite',k:'severite critique modere faible niveau gravite limites',h:'limits.html#severity',p:'limites'},
  ...
  {t:'FID instable',k:'fid shapefile compactage repack preuve cible non prouvee refus annulation insert ressemblance identite forte extension gpkg',h:'limits.html#fid-instable',p:'limites'},
  {t:'Horizon de recuperation',k:'fid recycle sans cle primaire pk horizon rewind cible introuvable retention failed_target_absent cycle_summary',h:'limits.html#fid-recycling',p:'limites'},
  {t:'FID = -1',k:'fid -1 entite en cours de creation avant commit identite temporaire',h:'limits.html#fid-minus-one',p:'limites'},
  ...
  {t:'Modifications hors QGIS',k:'hors qgis script python ogr2ogr arcgis autre logiciel non capture signaux',h:'limits.html#outside-qgis',p:'limites'},
  {t:'Enregistrement desactive',k:'suivi desactive bouton capture arretee aucun rattrapage historique vide',h:'limits.html#tracking-off',p:'limites'},
  {t:'Disque plein',k:'disque plein espace libre seuil 100 mo 500 mo suivi desactive reactivation automatique',h:'limits.html#disk-full',p:'limites'},
  {t:'Crash QGIS',k:'crash wal writequeue pending integrite recuperation perte evenements',h:'limits.html#crash',p:'limites'},
  {t:'Derive de schema et restauration',k:'schema drift champ ajoute supprime renomme type restauration incomplete rapport compatibilite',h:'limits.html#schema-drift',p:'limites'},
  {t:'Edition concurrente',k:'concurrent plusieurs utilisateurs poste partage journal separe ecrasement postgis',h:'limits.html#concurrent-edit',p:'limites'},
  {t:'Couche memoire',k:'memory volatile temporaire scratch refusee aucune capture aucun historique',h:'limits.html#memory-layer',p:'limites'},
  {t:'Taille du journal',k:'taille journal seuils sante healthy info warning critical 100000 evenements purge',h:'limits.html#journal-size',p:'limites'},
  {t:'Journal supprime',k:'journal supprime dossier recoverland efface antivirus nettoyage historique perdu',h:'limits.html#journal-deleted',p:'limites'},
  {t:'Projet deplace',k:'projet deplace qgz empreinte projet dossier recoverland introuvable',h:'limits.html#project-moved',p:'limites'},
  {t:'Journaux orphelins',k:'orphelin projet non sauvegarde profil nettoyage 30 jours export maintenance',h:'limits.html#orphan-journals',p:'limites'},
  {t:'Ce que RecoverLand n\'est pas',k:'pas de versionnement pas de sauvegarde pas de collaboration pas ctrl z filet de securite local',h:'limits.html#what-rl-is-not',p:'limites'},
